...
def _listing_row_to_dict(r: ListingRow, jurisdiction_id: uuid.UUID, source: str, filename: str) -> dict[str, Any]:
    return {
        ...
        "recorded_owner_phone": r.recorded_owner_phone,
    ...
    if rows:
        ...
        stmt = stmt.on_conflict_do_update(
            ...
            set_={
                ...
                "owner_phone": stmt.excluded.owner_phone,
                "owner_contact": stmt.excluded.owner_contact,
                "owner_address": stmt.excluded.owner_address,
                "recorded_owner_name": stmt.excluded.recorded_owner_name,
                "recorded_owner_phone": stmt.excluded.recorded_owner_phone,
