...
async def backfill_parcel_zoning_from_districts(
    ...
    *,
    ...
    """
    Backfill `parcels.zone_class` using parcel/polygon intersection instead of
    centroid-only containment. When multiple districts intersect a parcel, keep
    the district with the largest overlap area.
    """
    zone_code_set = (
