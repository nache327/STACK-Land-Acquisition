"""Phase 7F.3 — Sewickley PA Borough zoning Class A ingest.

Per Diagnostic 2026-06-22 re-verification: Sewickley PA Borough live
FeatureServer confirmed live (2014 vintage acceptable per orchestrator).

Source: services1.arcgis.com/Ps1YVQiv5JQLIFu2/.../SW_ZONING_5-5-14/FeatureServer/0
- 26 polygons (true zoning map)
- ZONE field (NOT 'Zoning'), 9 distinct codes
- Polygon geometry

Sewickley jurisdiction (Phase 7F.2 PR #316):
  abee4cb9-9e1f-4859-b10e-f86832b98491 (1,115 parcels)
"""
...
logger = logging.getLogger("sewickley_pa")

JID = "abee4cb9-9e1f-4859-b10e-f86832b98491"
MUNI = "Sewickley Borough"
LAYER = "https://services1.arcgis.com/Ps1YVQiv5JQLIFu2/arcgis/rest/services/SW_ZONING_5-5-14/FeatureServer/0"
ZCODE = "ZONE"
RAW_KEYS = ("FID", "ZONE", "Z_DESC", "ACRES")
BBOX_LON = (-80.21, -80.14)
BBOX_LAT = (40.52, 40.56)
...
async def _fire(near=50.0):
    ...
    for f in feats:
        ...
        raw = {"source_url": LAYER, "source_kind": "arcgis_feature_server",
               ...
               "publisher": "Sewickley Borough PA GIS (Diagnostic 2026-06-22 re-verified, 2014 vintage)"}
        for k in RAW_KEYS:
