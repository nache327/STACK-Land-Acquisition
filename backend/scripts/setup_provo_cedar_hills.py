"""
Full setup for Provo, UT and Cedar Hills, UT:
  1. Create jurisdiction record (Cedar Hills only — Provo already exists)
  2. Download UGRC Utah County parcels → insert into DB
  3. Spatial join to Utah County CommercialAppraiser zoning layers 29 / 18
  4. Build zone_use_matrix

Run from backend/ directory:
    python scripts/setup_provo_cedar_hills.py
"""
...
CITY_CONFIGS = [
    {
        "name": "Provo",
        "existing_jur_id": "f614c2e6-5ef2-4c0f-ac67-70d74177760b",
        "parcel_city": "Provo",
        "zoning_layer": 29,
        "label_field": "ZONE_PR_LABEL",
        "desc_field": "ZONE_PR_DESC",
    },
    {
        "name": "Cedar Hills",
        "existing_jur_id": None,
        "parcel_city": "Cedar Hills",
        "zoning_layer": 18,
        "label_field": "ZONE_CH_LABEL",
        "desc_field": "ZONE_CH_DESC",
    },
]
...
CLASSIFIERS = {
    "Provo": classify_provo,
    "Cedar Hills": classify_cedar_hills,
}
