      ...
      <div className="relative w-full max-w-md space-y-8">
        ...
        <div className="flex flex-col items-center gap-4 text-center">
          ...
          <div>
            <h1 className="text-xl font-semibold text-white">
              {job.status === "failed" ? "Analysis failed" : "Analyzing jurisdiction…"}
            </h1>
                ...
                >
                  ...
                  <span className="w-5 text-center font-mono text-base leading-none">
                    {done ? (
                      ...
                      <span className="text-slate-700">{STEP_ICONS[step] ?? "○"}</span>
                    )}
                  </span>
        ...
        {job.status === "failed" && (
          <div className="rounded-xl border border-red-900/50 bg-red-950/40 p-4">
            ...
            <p className="mt-1.5 font-mono text-xs text-red-500/80">{job.error_message}</p>
          </div>
        )}
