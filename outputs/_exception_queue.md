...
|---|---|---|---|---|
| 3 | A | Littleton / Middlesex MA | **Same eCode360 access wall as #2.** Littleton zoning = eCode360 Ch.173 (Use Regulations Schedule); bot-blocked (WebFetch 403, curl → SPA). Town's full Town-Code PDF (`DocumentCenter/View/1863`, 279pp text) is the GENERAL bylaws — it does NOT contain the Ch.173 zoning use schedule / district-establishment / warehouse rows. Town FAQ directs residents to eCode360 or a $15 printed copy. Could not retrieve a parseable district list or use table → can't build a vocab-checked rebind config or ground. **SYSTEMIC:** eCode360-hosted towns (Chelmsford #2, Littleton, likely Westford/Tyngsborough) all hit this — MAPC/NMCOG gives parcel vocab but the bylaw use table is unreachable. | Paste (or provide a text PDF of) Littleton Ch.173 Table of Use Regulations + district list. **Systemic ask:** for eCode360 munis, either paste the use tables, host town PDFs, or authorize an authenticated/alternate fetch path so I can self-serve. |
