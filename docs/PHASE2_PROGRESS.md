...
|---|---|---|---|---|
| A — Integrator | B9 classified/fixed/merged/deployed; B6/B8 remain separate follow-ups | PR #109 merged (`0afa78a`) | B6 active separate follow-up; B8 parked separate follow-up | 2026-05-26 23:00 UTC (`/health.pipeline_version: 0afa78a07579`; Nassau `3c7ce534`) |
