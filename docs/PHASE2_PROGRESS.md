...
|---|---|---|---|---|
| A — Integrator | B6 fatal post-overlay/run_overlays terminal failure cleared; warning remains log-only evidence | none | B8 reopened with Nassau parked; B7 cleared on Monmouth | 2026-05-28 19:43 UTC (Westchester `9f8ecb57` ready) |
...
| C — Spatial + CRS | bbox refresh sweep for 7 jurisdictions with bbox NULL | — | none for reliability queue | 2026-05-28 19:43 UTC (master wake) |
